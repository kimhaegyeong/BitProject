		...
		.ready(
				function() {
												...
												.wysiwyg(
														{
															...
															buttons : {
																...
																dummybutton1 : index != 1 ? false
																		: {
																			html : $(
																					'<input id="submit" type="button" value="bold" />')
																					.click(
																							function() {
																								// We
																								// simply
														 ...
														 * .ajaxSubmit({ //
														 * success:
														 * function(xhrdata,textStatus,jqXHR){ //
														 * var image_url =
														 * xhrdata; //
														 * console.log( 'URL: ' +
														 * image_url ); //
					...
					var option = {
						...
						onkeypress : function(code, character, shiftKey,
								altKey, ctrlKey, metaKey) {
							if (typeof console != 'undefined')
								console.log('RAW: ' + character
										+ ' key pressed');
						},
						onselection : function(collapsed, rect, nodes,
								rightclick) {
							if (typeof console != 'undefined' && rect)
								console.log('RAW: selection rect(' + rect.left
										+ ',' + rect.top + ',' + rect.width
										+ ',' + rect.height + '), '
										+ nodes.length + ' nodes');
						},
