...
public class BoardControl04 {
  static Logger log = Logger.getLogger(BoardControl04.class);
  ...
  public Object add(Board board) throws Exception {
    ...
    System.out.println(">>이미지 : " + board.getImg());

    if (board.getImg() != null
        && !board.getImg().isEmpty()) {
      ...
      System.out.println(">>지정파일이름 : " + filename);
