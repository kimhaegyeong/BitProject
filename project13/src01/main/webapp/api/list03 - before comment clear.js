		...
		$.ajax({
			...
			success : function(responseData, textStatus, errorThrown) {
				if (Object.keys(saveList).length == 0) {
					...
					/** ***************************************************************** */
					console.log("<><><><>/nsaveList 길이 확인 : "
							+ Object.keys(saveList).length);
					console.log(saveList);
					console.log(temp);
				 ...
				 * responseData.channel.item[3].publish_date);
				...
				// yyyyMMddpriceResultFormat(responseData));
				// var transformData = yyyyMMddpriceResultFormat(responseData);

				/*
				 * console.log("이후---------------"); console.log("responseData : " +
				 * responseData.channel.item[3].publish_date);
				 * console.log("saveList : " + saveList[3].publish_date);
				 * console.log("transformData : " +
				 * transformData.channel.item[3].publish_date);
				 */
				/** *********************************************************************** */
				 ...
				 * console.log("responseData : " +
				 * responseData.channel.item[3].price_min);
				 * console.log("saveList : " + saveList[3].price_min);
				 * console.log("transformData : " +
				 * transformData.channel.item[3].price_min);
				 */
				/* 가격 포맷 */
